...
/sbin/busybox echo 5.6 CF - 6.0.3.7 > /customkernel/property/customkernel.cwm.version
/sbin/busybox echo 5.15.0 > /customkernel/property/customkernel.cwm.touch.build
/sbin/busybox echo true > /customkernel/property/customkernel.base.PhilZ-cwm6
/sbin/busybox echo 5.15.0 > /customkernel/property/customkernel.base.version
/sbin/busybox echo XXLTA-ATL > /customkernel/property/customkernel.firmware.name
